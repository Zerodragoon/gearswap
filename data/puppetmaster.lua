...
function get_sets()
	...
	send_command('input /macro book 10;wait .1;input /macro set 3;wait 0.5;input //gs org;wait 2.0; input /lockstyleset 28;wait 1.0;lua l autocontrol;wait .5; autocontrol show')
