 function get_sets()
	...
	Weapon_Set_Names = {'Fomalhaut', 'Gastraphetes', 'Annihilator', 'Armageddon', 'FailNot', 'Ambu', 'Sparrowhawk', 'Anarchy', 'Sharanga', 'Yochi'}
	...
	Hands_Set_Names = {'PhysicalShield', 'MagicalShield', 'KustawiShield', 'RaeticShield', 'AmbuSwordShield', 'AmbuKnifeShield', 'AmbuAxeShield', 'Crit', 'Physical', 'Magical', 'Kustawi', 'AmbuSwordKnife', 'Raetic', 'AmbuKnifeSword', 'AmbuAxe', 'SwordCrit', 'KrakenP', 'KrakenM', 'AmbuSwordBlurred', 'PerunKusta'}
	...
	sets.Hands.AmbuSwordBlurred = { 
		main="Naegling",
		sub="Blurred Knife +1"
	}

	sets.Hands.PerunKusta = { 
		main="Perun +1",
		sub="Kustawi +1"
	}
						
	--Midshot Sets Below
	Midshot_Set_Names = {'Standard', 'StandardAlt', 'Acc','Attack', 'Crit', 'CritDamage'}
	sets.Midshot = { 
	...
	sets.TrueFlight  = {
		...
		hands={ name="Herculean Gloves", augments={'Mag. Acc.+19 "Mag.Atk.Bns."+19','Weapon skill damage +5%','STR+3','"Mag.Atk.Bns."+7',}},
	...
	sets.TrueFlight.Acc = set_combine(sets.TrueFlight, {
		...
		hands="Oshosi Gloves +1",
		legs="Oshosi Trousers +1",
		feet={ name="Herculean Boots", augments={'Pet: Attack+26 Pet: Rng.Atk.+26','Mag. Acc.+30','Quadruple Attack +2','Accuracy+10 Attack+10','Mag. Acc.+19 "Mag.Atk.Bns."+19',}},
		waist="Eschan Stone",
		ring1="Dingir Ring",
		ring2="Mummu Ring"
	 })
	...
	Melee_Set_Names = {'DT', 'DTAcc', 'DblAtt45', 'DblAtt30', 'DblAtt15', 'DblAtt0'}
	...
	sets.Melee.DblAtt30 = set_combine(sets.DblAtt45, {
		ear2="Eabani Earring"
	})

	sets.Melee.DblAtt15 = set_combine(sets.DblAtt30, {
		legs="Carmine Cuisses +1"
	})

	sets.Melee.DblAtt0 = set_combine(sets.Melee, {
